...
import { DeepLinkToQRParams, DeepLinkToQRLocalParams } from './types/qr-types.js';
...
server.tool(
  "deeplink_to_qr",
  "Convierte un deep link de Radix Wallet a código QR en formato SVG y/o PNG",
  DeepLinkToQRSchema,
  async (params) => {
    try {
...
server.tool(
  ...
  "Genera un código QR como archivo PNG local para deep links de Radix Wallet, compatible con Claude Desktop",
  DeepLinkToQRLocalSchema,
  async (params) => {
    try {
